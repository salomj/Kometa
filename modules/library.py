...
class Library(ABC):
    def __init__(self, config, params):
        ...
        self.mass_title_update = params["mass_title_update"]
        ...
        self.items_library_operation = True if self.assets_for_all or self.mass_genre_update or self.remove_title_parentheses \
                                               ...
                                               or self.mass_content_rating_update or self.mass_originally_available_update or self.mass_added_at_update or self.mass_title_update or self.mass_original_title_update\
        ...
        for i, item in enumerate(items, 1):
            ...
            if key not in self.movie_rating_key_map and key not in self.show_rating_key_map:
                ...
                if main_id:
                    ...
                    elif library_id == "TVDb" and id_type == "show":
                        if len(main_id) > 1:
                            for _id in main_id:
                                try:
